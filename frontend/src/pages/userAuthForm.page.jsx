        ...
        </h1>
        {
...

         {
            ...
            <p className='text-center text-dark-grey text-xl mt-6'>
                Don't have an account? <Link to="/signup" className='text-black underline text-xl '>Sign Up</Link>
            </p>    
            :
            <p className='text-center text-dark-grey text-xl mt-6'>
                Already have an account? <Link to="/signin" className='text-black underline text-xl'>Sign In</Link>
            </p>    
    }
      </form>
    </section>
